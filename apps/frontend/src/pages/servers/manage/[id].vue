<template>
  <div class="contents">
    ...
    <div
      ...
      class="experimental-styles-within mobile-blurred-servericon relative mx-auto box-border flex min-h-screen w-full min-w-0 max-w-[1280px] flex-col gap-6 px-3 transition-all duration-300 sm:px-6"
      :style="{
